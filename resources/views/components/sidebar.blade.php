    ...
    <div class="sidebar-wrapper active">
        <div class="sidebar-header position-relative">
            <div class="d-flex justify-content-between align-items-center">
                <div class="logo">
                    <a href="index.html"><img src="{{ asset('assets/compiled/png/logocls.png') }}" alt="Logo"
                            srcset=""></a>
                </div>
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item {{ request()->routeIs('colors') ? 'active' : '' }}">
                    <a href="colors" class='sidebar-link'>
                ...
                <li class="sidebar-item {{ request()->routeIs('product-images') ? 'active' : '' }}">
                    <a href="product-images" class='sidebar-link'>
